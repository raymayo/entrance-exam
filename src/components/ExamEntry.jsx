      ...
      <div className="titleHead">
        ...
        <p>Entrance Exam</p>
			...
			<div className="col1">
				...
				<div>
					<label>Sex</label>
					<select name="genderSelect" id="genderSelect" onChange={handleChange} value={formData.genderSelect} required>
          ...
          <select name="course1st" value={formData.course1st} onChange={handleChange} required>
          ...
          <select name="course2nd" value={formData.course2nd} onChange={handleChange} required>
						<option  value="" disabled>Select Course</option>
						<option value="Course 1">Course 1</option>
						<option value="Course 2">Course 2</option>
						<option value="Course 3">Course 3</option>
