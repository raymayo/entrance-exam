...
const Print = () => {
	...
	return (
		...
		<div id="printContainer" ref={contentRef}>
            ...
            <h3>Subic, Zambales</h3>
                ...
                <div id="infoContainer">
                    <p id='name'>Name: <span className='userData'>{userData.fullName}</span></p>
                    <p id='sex'>Sex: <span className='userData'>{userData.genderSelect}</span></p>
                    <p id='address'>Address: <span className='userData'>{userData.address}</span></p>
                    <p id='birthday'>Date of Birth: <span className='userData'>{userData.birthday}</span></p>
                    <p id='birthplace'>Place of Birth: <span className='userData'>{userData.birthplace}</span></p>
                    <p id='contactNum'>Contact Number: <span className='userData'>{userData.contactNo}</span></p>
            ...
            <div className="letterScore">
                <p id='date'>DATE: <span className='userData'>{userData.Date}</span></p>
                <p id='letter1'>Mr./Ms <span className='userData'>{userData.fullName}</span> is granted to take the Entrance Examination on <span className='userData'>{userData.Date}</span> at <span>COMLAB2</span> </p>
                <div className="nameSig">
                    <p className="namePlate">Ms. Thelma Laxamana</p>
                    <p className="titlePlate">Registrar</p>
                </div>
            ...
            <div id="examResult">
                <div>
                    <p><span className='userData'>{userData.english || 'No Score'}</span> English</p>
                    <p><span className='userData'>{userData.math || 'No Score'}</span> Mathematics</p>
                    <p><span className='userData'>{userData.filipino || 'No Score'}</span> Filipino</p>
                </div>
                <div>
        ...
        <motion.button id='pdf' onClick={generatePdf} whileHover={{scale:1.1}} whileTap={{scale:1}} ><MdFileDownload onClick={generatePdf} size={25}/>Download</motion.button>
